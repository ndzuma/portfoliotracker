    ...
    <Card className="p-4 bg-card border-border">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-2xl font-semibold text-foreground mt-1">{benchmark.value.toLocaleString()}</p>
        </div>
    ...
    <div className="flex items-center gap-4 py-3 px-4 hover:bg-muted/50 transition-colors">
      <div className="flex-1 min-w-0">
        <Link href={`/dashboard/portfolio/${portfolio.id}`} className="block">
          <h3 className="font-medium text-foreground hover:text-primary transition-colors">{portfolio.name}</h3>
      ...
      <div className="flex items-center gap-2 min-w-0">
        ...
        <div className="text-right">
          <div className={`font-medium ${isPositive ? "text-primary" : "text-secondary"}`}>
            ${Math.abs(portfolio.change).toLocaleString()} ({isPositive ? "+" : ""}
      ...
      <div className="flex items-center gap-2">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={() => onDelete(portfolio.id)} className="text-secondary focus:text-secondary">
...
export default function PortfoliosDashboard() {
  ...
  const [portfolios, setPortfolios] = useState<{ personal: Portfolio[] }>({ personal: [] })
  ...
  const totalValue = portfolios.personal.reduce((sum, portfolio) => sum + portfolio.value, 0)
  const totalChange = portfolios.personal.reduce((sum, portfolio) => sum + portfolio.change, 0)
      ...
      <div className="max-w-7xl mx-auto p-6">
            ...
            <Dialog open={isAddAssetModalOpen} onOpenChange={setIsAddAssetModalOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>Add a new asset to one of your portfolios.</DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setNewAsset({ ...newAsset, portfolioId: value })}
                    >
                      <SelectTrigger>
                ...
                <DialogFooter>
                  <Button variant="outline" onClick={() => setIsAddAssetModalOpen(false)}>
                    Cancel
                  </Button>
                  <Button
                    onClick={handleAddAsset}
                    disabled={!newAsset.symbol || !newAsset.quantity || !newAsset.avgBuyPrice || !newAsset.portfolioId}
                  >
                    Add Asset
                  </Button>
                </DialogFooter>
            ...
            <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Set up a new portfolio to track your investments. You can add assets after creation.
                  </DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                  ...
                  <div className="grid gap-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="speculative">Speculative Trading</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="initial">Initial Investment (Optional)</Label>
                    <Input
                      id="initial"
                      type="number"
                      placeholder="0.00"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <div className="lg:col-span-2">
            <Card className="p-6 bg-card border-border h-full">
              <div className="flex items-center justify-between h-full">
                <div>
                  <h2 className="text-lg font-medium text-muted-foreground mb-2">Total Portfolio Value</h2>
          ...
          <div>
            <AISummaryCard
              ...
              content="Your portfolio shows strong diversification with 65% in growth stocks and 35% in defensive assets. Recent tech sector gains have boosted overall performance by 8.2% this quarter. Consider rebalancing if tech allocation exceeds 40% to maintain optimal risk distribution."
            />
          </div>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-medium text-foreground">My Portfolios ({portfolios.personal.length})</h2>
          </div>
          ...
          <Card className="bg-card border-border">
            <div className="flex items-center gap-4 py-3 px-4 border-b border-border bg-muted/30">
              ...
              <div className="min-w-[120px] text-center font-medium text-foreground">Valuation</div>
              <div className="min-w-[100px] text-center font-medium text-foreground">Value</div>
              <div className="min-w-[80px] text-center font-medium text-foreground">Modified</div>
