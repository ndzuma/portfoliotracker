...
import { Download, Globe, DollarSign, Palette, FileText, Save } from "lucide-react"
      ...
      portfolios: [
        {
          ...
          assets: [
            ...
            { symbol: "MSFT", name: "Microsoft Corporation", value: 6200, shares: 25 },
    ...
    if (format === "CSV") {
      const csvContent = [
        ...
        ...portfolioData.portfolios[0].assets.map(
          (asset) => `${asset.symbol},${asset.name},${asset.value},${asset.shares}`,
        ),
      ].join("\n")
      ...
      <div className="grid gap-6 max-w-4xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Set your preferred currency for displaying portfolio values</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Customize the look and feel of your portfolio dashboard</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">Current theme: {theme === "dark" ? "Dark" : "Light"}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Download your portfolio data in various formats</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Exported files will include all portfolio holdings, performance data, and transaction history.
            </p>
          </CardContent>
        </Card>
