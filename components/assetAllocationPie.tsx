      ...
      <CardContent>
        {isLoading ? (
          <div className="mx-auto aspect-square max-h-[250px] flex items-center justify-center">
            <div className="aspect-square w-full max-h-[250px] flex flex-col items-center justify-center">
              <div className="rounded-full h-32 w-32 bg-muted animate-pulse"></div>
            </div>
          </div>
        ) : hasNoData ? (
          <div className="mx-auto aspect-square max-h-[250px] flex items-center justify-center">
